...
$config['main'] = array(
			...
			'username'	=> 'AsoStrife',
			'slogan'	=> 'Master\'s Graduate &amp; Software Developer', 
			'main_title'		=> 'Andrea Corriga (@AsoStrife) &bull; Master\'s Graduate and Developer', 
			'second_title'		=> ' &bull; Andrea Corriga (@AsoStrife)', 
			'author'	=> 'Andrea Corriga (@AsoStrife)',
			'email'		=> 'me@andreacorriga.com',
			'description' => 'Hello World, I\'m Andrea Corriga (@AsoStrife) and this is my personal website. I\'m a Master\'s Graduate and Software Developer. In this website you can find my personal projects, publications, my social profile and other stuffs',
